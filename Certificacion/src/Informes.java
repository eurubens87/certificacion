...
public class Informes extends javax.swing.JFrame {
     ...
     */
    String[] auxilia = new String[10];
    public Informes() {
        initComponents();
        Conexion nuevo = new Conexion();
        nuevo.conectar();
        try {
           auxilia = nuevo.obtenerdatosC();
           for(int i = 1; i<11; i++)
           {
               if(auxilia[i].length() > 0)
               {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccionar curso del cuál registrará la carga del informe presentado:");
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try {
           ...
           aux = nuevo.obtenerdatosC();
        } catch (Exception e) {
           JOptionPane.showMessageDialog(null, "Ingrese un curso para cargar el estado del informe");
        }
